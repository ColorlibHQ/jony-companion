...
class Jony_social_links extends WP_Widget {
    ...
    function __construct() {
        ...
        esc_html__( '[ Jony ] Social Links', 'jony-companion' ),

        // Widget description
        array( 'description' => esc_html__( 'Add footer social links.', 'jony-companion' ), )
        );
    ...
    public function form( $instance ) {
        ...
        $title = isset( $instance[ 'title' ] ) ? $instance[ 'title' ] : esc_html__( 'Follow Us', 'jony-companion' );
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'facebook' ) ); ?>"><?php esc_html_e( 'Facebook URL:' ,'jony-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'twitter' ) ); ?>"><?php esc_html_e( 'Twitter URL:' ,'jony-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'linkedin' ) ); ?>"><?php esc_html_e( 'Linkedin URL:' ,'jony-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'instagram' ) ); ?>"><?php esc_html_e( 'Instagram URL:' ,'jony-companion'); ?></label>
        ...
        <p>
            <label for="<?php echo esc_attr( $this->get_field_id( 'dribbble' ) ); ?>"><?php esc_html_e( 'Dribbble URL:' ,'jony-companion'); ?></label>
...
} // Class jony_social_links ends here


// Register and load the widget
function jony_social_links_widget_load() {
	register_widget( 'Jony_social_links' );
}
add_action( 'widgets_init', 'jony_social_links_widget_load' );