...
/**
 *
 * Jony elementor skills section widget.
 *
 * @since 1.0
 */
class Jony_Skills extends Widget_Base {
	...
	public function get_title() {
		return __( 'My Skills', 'jony-companion' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			'skills_content',
			[
				'label' => __( 'Skills content', 'jony-companion' ),
			]
        );
        ...
        $this->add_control(
            'sec_title',
            [
                'label' => esc_html__( 'Section Title', 'jony-companion' ),
                'type' => Controls_Manager::TEXTAREA,
                'label_block' => true,
                'default'   => esc_html__( 'I’m a Creative director based on New York, who loves clean, simple & unique design. I also enjoy crafting', 'jony-companion' ),
            ]
        );
        $this->add_control(
            'about_yourself',
            [
                'label' => esc_html__( 'About Yourself', 'jony-companion' ),
                'type' => Controls_Manager::TEXTAREA,
                'label_block' => true,
        ...
        $this->add_control(
            ...
            [
                ...
                'label_block' => true,
                'default'   => esc_html__( 'Download CV', 'jony-companion' ),
            ]
        );
		...
		$this->add_control(
            'skills', [
                ...
                'fields' => [
                    [
                        'name' => 'item_title',
                        'label' => __( 'Skill Title', 'jony-companion' ),
                        'label_block' => true,
                        'type' => Controls_Manager::TEXT,
                        'default'     => __( 'Wireframing', 'jony-companion' ),
                    ],
                    [
                        'name' => 'skill_val',
                        'label' => __( 'Skill Value', 'jony-companion' ),
                        'label_block' => true,
                ...
                'default'   => [
                    [ 
                        'item_title'    => __( 'Weightlifting', 'jony-companion' ),
                        'skill_val'   => __( '90', 'jony-companion' ),
                    ],
                    [ 
                        'item_title'    => __( 'UI/UX', 'jony-companion' ),
                        'skill_val'   => __( '70', 'jony-companion' ),
                    ],
                    [ 
                        'item_title'    => __( 'Interaction design', 'jony-companion' ),
                        'skill_val'   => __( '45', 'jony-companion' ),
                    ],
                ]
            ]
		);
     ...
     */
        ...
        $this->start_controls_section(
            'style_features_section', [
                'label' => __( 'Style Features Section', 'jony-companion' ),
        ...
        $this->add_control(
            ...
            [
                'label' => esc_html__( 'BG Styles', 'jony-companion' ),
                'type' => Controls_Manager::HEADING,
                'separator' => 'after'
            ]
        );
        $this->add_control(
            'sec_bg_color', [
                'label' => __( 'Bg Color', 'jony-companion' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
