(function ($) {
    ...
    if ($.fn.owlCarousel) {
        $(".jony-service-slides").owlCarousel({
            items: 3,
            loop: true,
            autoplay: true,
            smartSpeed: 800,
    ...
    if ($.fn.owlCarousel) {
        $(".jony-workflow-slides").owlCarousel({
            items: 3,
            loop: true,
            autoplay: true,
            smartSpeed: 800,
    ...
    if ($.fn.imagesLoaded) {
        $('.jony-portfolio').imagesLoaded(function () {
            ...
            // init Isotope
            var $grid = $('.jony-portfolio').isotope({
    ...
    // MC Scripts
    var $subscribe = $('.jony-subscribe-newsletter-area');
    if ($subscribe.length) {
